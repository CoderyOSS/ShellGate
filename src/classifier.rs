...
pub fn classify_command(_command: &str, _args: &[String]) -> CommandClass {
...
pub fn extract_repo(_command: &str, _args: &[String], _cwd: &str) -> Result<String, GateError> {
...
pub fn match_glob_pattern(_pattern: &str, _text: &str) -> bool {
